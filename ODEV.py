...
class Sauce_Test:
    ...
    def test_mission_1(self, username, password):
        ...
        assert hatalimesaj.text=="Epic sadface: Username is required"
    ...
    def test_mission_2(self, username, password):
        ...
        hataligiris=self.driver.find_element(By.XPATH, "/html/body/div/div/div[2]/div[1]/div/div/form/div[3]/h3")
